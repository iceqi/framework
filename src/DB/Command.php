...
class Command extends Object
{
    ...
    /**
     * @var \Kerisy\Cache\Dependency the dependency to be associated with the cached query result for this command
     * @see cache()
     */
     ...
     * @param \Kerisy\Cache\Dependency $dependency the cache dependency associated with the cached query result.
    ...
    public function execute()
    {
        ...
        try {
            ...
            //下次操作重新建立连接
            if ($this->pdoStatement->errorCode() == 'HY000') {
                $this->db->pdo = null;
            }
