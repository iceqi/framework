...
class Connection
{
     ...
     * Use 0 to indicate that the cached data will never expire.
     * @param \Kerisy\Cache\Dependency $dependency the cache dependency associated with the cached query results.
     ...
     * @param \Kerisy\Cache\Dependency $dependency the preferred caching dependency. If null, it will be ignored.
